...
WaterRenderer::WaterRenderer()
{
	...
	reflection_fbo_ = std::make_unique<Fbo>(1280, 720, DepthBufferAttachment::DepthBuffer, false);
	refraction_fbo_ = std::make_unique<Fbo>(1280, 720, DepthBufferAttachment::DepthTexture, false);
