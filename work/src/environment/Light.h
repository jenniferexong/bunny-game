...
public:
	static constexpr float min_sunlight = 0.1f;
	static constexpr float max_sunlight = 1.0f;
	static constexpr int max_lights = 40;
	static constexpr glm::vec3 point_light_attenuation = glm::vec3 (
		1.f, 0.01, 0.002
	);
	...
	Light(glm::vec3 position, glm::vec3 color, glm::vec3 attenuation): 
		position_(position), color_(color), attenuation_(attenuation) {}
